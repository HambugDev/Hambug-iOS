...
final class CommunityAPIClient: CommunityAPIClientInterface {
...
// MARK: - Mock API
final class MockCommunityAPIClient: CommunityAPIClientInterface {
  ...
  func fetchBoardsByCategory(_ category: Category) -> AnyPublisher<[BoardFeedResponse], NetworkError> {
    let mockData = [
      BoardFeedResponse(
        id: 1,
        imageURL: "https://example.com/image1.jpg",
